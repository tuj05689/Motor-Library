###########################################################################
## Makefile generated for Simulink model 'DualVNHMotor'. 
## 
## Makefile     : DualVNHMotor.mk
## Generated on : Wed Apr 24 11:53:19 2019
## MATLAB Coder version: 4.1 (R2018b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/DualVNHMotor.elf
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/Adam0/Desktop/CONTRO~1/MOTOR-~1
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/DualVNHMotor.elf
...
DEFINES_STANDARD = -DMODEL=DualVNHMotor -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/DualVNHMotor_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : $(START_DIR)/DualVNHMotor_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/DualVNHMotor_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
