 ...
 *
 */
extern "C" void sfunc_dcmotor_Outputs_wrapper(const real_T *spd1,
			const real_T *spd2,
			const real_T *xD)
{
...
/* get encoder position and set is as output */ 
         ...
         md.setM1Speed(spd1[0]);
         md.setM2Speed(spd2[0]);
 ...
 *
 */
extern "C" void sfunc_dcmotor_Update_wrapper(const real_T *spd1,
			const real_T *spd2,
			real_T *xD)
{
