 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Wed Apr 24 11:30:24 2019
 */
...
{
    const real_T *spd1 = (real_T *) ssGetInputPortRealSignal(S, 0);
    const real_T *spd2 = (real_T *) ssGetInputPortRealSignal(S, 1);
    const real_T *xD = ssGetDiscStates(S);

    sfunc_dcmotor_Outputs_wrapper(spd1, spd2, xD);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    sfunc_dcmotor_Update_wrapper(spd1, spd2, xD);
